...
@section('header')
  <div class="flex items-end justify-between">
    <div>
      <h1 class="text-3xl font-bold text-indigo-700 dark:text-indigo-400">Editar registro</h1>
      <p class="text-sm text-gray-600 dark:text-slate-400">Modifica los datos y guarda.</p>
    </div>
...
@section('content')
  ...
  <form method="POST" action="{{ route('insertion_checks.update', $check) }}"
