  ...
  <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
    <div>
      ...
      <p class="text-sm text-gray-600 dark:text-slate-400 mt-1">
        Actualiza los datos o documentos asociados a este convenio.
      </p>
    </div>
...
@section('content')
  ...
  <form method="POST" action="{{ route('agreements.update', $agreement) }}"
    ...
    <div class="flex items-center gap-3 border-b border-gray-100 dark:border-slate-700 pb-3 mb-2">
      ...
      <div>
        <h2 class="font-semibold text-lg text-gray-800 dark:text-slate-200">Datos del convenio</h2>
        <p class="text-sm text-gray-500 dark:text-slate-400">Edita la información que desees actualizar.</p>
      </div>
    </div>
