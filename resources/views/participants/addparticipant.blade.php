...
<div class="max-w-3xl mx-auto px-4 py-8">
    <h1 class="text-2xl font-semibold mb-6">Nuevo participante</h1>

    <form method="POST" action="{{ route('saveparticipant') }}" class="space-y-4">
        @csrf
        @include('partials.participant_form', ['participant' => null])
